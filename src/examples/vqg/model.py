...
class VQGModel(nn.Module):
    def __init__(self, args, tokenizer) -> None:
        ...
        if args.variant in ("icodqaf-icodqaf", "icodqaf-icof", "icodf-icodf", "icf-icf", "iodf-iodf"):
        ...
        # if args.variant in ("icod-icod-l,lg,lv,ckl", "icodf-icodf-l,lg,lv,akl"):
        #     from variants.icod_icod_l import icod_icod_l
        #     self.model = icod_icod_l(args, tokenizer)

        # if args.variant in ("icodf-icodf-l,lg,lv,akl"):
        #     from variants.icodf_icodf_l import icodf_icodf_l
        #     self.model = icodf_icodf_l(args, tokenizer)
